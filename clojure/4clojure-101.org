...
They all passed the tests but only the last one did pass without timeout on 4clojure.
...
So I tried to act on this but failure, tests ok, timeout on 4clojure.
