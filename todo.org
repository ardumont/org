...
- [X] Fix synaptics errors on non mobile nixos computer
- [X] Fix pb with myrkr (apparently fixed by formatting /home)
- [ ] Fix autojump not working on nixos box
