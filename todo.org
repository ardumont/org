...
* TODO nix and haskell dev
http://nixos.org/nixpkgs/manual/#how-to-create-a-development-environment
* mbsync/offlineimap
* TODO gpg tools
- [X] signing-party (caff for signing keys)
- [ ] parcimonie (to silently update keys through tor)
* TODO offlineimap.el
from julien danjou, might learn tons of stuff about process
...
- [ ] Improve packaging of mainstream jabber-otr to avoid duplication in my repo
