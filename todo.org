...
- [ ] 0.6.9
- [ ] ...
* IN-PROGRESS Blog [2/7]
- [X] Migrate comment system to Disqus
- [X] Migrate from wordpress to a github solution -> ardumont.github.io [3/3]
...
- [ ] Update my multiple references to my old blog to the new one
- [ ] Improve my blog's visual
- [ ] Ensure the blog is web responsive
- [ ] Automate the publication (let github do the job?)
- [ ] Merge ardumont/org into ardumont/ardumont.github.io?
* DONE Bootstrap org2jekyll - https://github.com/ardumont/org2jekyll
CLOSED: [2014-12-20 Sat 00:21]
