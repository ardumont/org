...
- [X] Access to mysql (mint + nixos tryouts)
- [X] Forward mail from inria address to gmail address
- [X] Access to vpn
- [X] Retake control of mail-pack
- [X] Fix some issues on org-trello
- [X] understand how screenkey works (record screen keys during screen cast)
- [X] Create an emacs daemon service in nixos
- [X] FAIL: Create an offlineimap + mu service in nixos -> Need to access the gpg authentication mechanism. No need, emacs already does it.
- [ ] Learn again how to make debian package (+ in nix env) -> https://www.debian.org/doc/manuals/packaging-tutorial/packaging-tutorial.pdf (Thanks Zack)
- [ ] Take control of your gpg key (sign, encrypt)
- [ ] Import some known ones
- [ ] Publish gpg public key
- [ ] [[https://www.gnupg.org/documentation/index.html][gpgme]]
- [ ] Learn some mutt love
* TODO domain name
