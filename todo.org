...
* TODO How to reproduce nix's userland and git it?
* TODO keysnail
...
- [ ] Propose a fix about pidgin-with-plugins which miss the folder containing the plugins
- [ ] Propose a fix about proxy to expose the env no_proxy variable too (not specified right now and create problems when developping local web app)
- [ ] Fix lid close event (sometimes, when opening the lid, it closes again) -
...
* IN-PROGRESS judo
* IN-PROGRESS Refresh on angular-js
- [-] https://docs.angularjs.org/tutorial [7/13]
  - [X] 0 - Bootstrapping
  - [X] 1 - Static Template
...
- [X] Propose improvment about nix-shell integration in haskell-mode - https://github.com/haskell/haskell-mode/pull/370
