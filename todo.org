...
- [ ] http://blog.sanctum.geek.nz/linux-crypto-disks/
- [ ] http://blog.sanctum.geek.nz/linux-crypto-importance/
...
* TODO udisks
* TODO [[http://software.schmorp.de/pkg/rxvt-unicode.html][rxvt-unicode]]
* DONE fonts
...
- [ ] Adapt prefix key for xmonad/stumpwm depending on the running context (main window manager or embedded in xephyr)
- [ ] Confirm before stopping xmonad session or reloading configuration
...
** NixOS [40%]
- [X] nixos - http://nixos.org/nixos/manual/
- [X] Install nixos -> https://github.com/ardumont/dot-files/blob/master/configuration.nix
- [ ] Fix trouble with X (it may be my personal xmonad.hs's deps that are not satisfied)
- [ ] Make user environment in nixos as painless as usual (not yet at ease)
