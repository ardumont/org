...
* IN-PROGRESS Chris's machine - alderaan [3/4]
- [X] Reboot old machine
- [X] Install pci wifi card + new hdd
- [X] Install NixOS for alderaan
- [ ] Make alderaan's setup shareable with other machines' [/]
  - [ ] extract xserver's setup inside each machine for one (chris does not use xmonad)
