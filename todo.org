...
- [ ] FAIL: Create an offlineimap + mu service in nixos -> Need to access the gpg authentication mechanism
...
* TODO GTD
* TODO xmonad
- [ ] Fix nixos's xmonad recompile and restart procedure in nixos
