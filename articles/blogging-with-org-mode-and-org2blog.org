...
#+OPTIONS: TOC:nil
#+CATEGORIES: org-mode, emacs, wordpress, blog, org2blog, tools
#+DESCRIPTION: Syncing one's org-mode files with one's blog using org2blog

* Statements
- I'm a [[http://localhost:4000/feedback-loop][feedback addict]]
...
- I love [[https://www.gnu.org/software/emacs/][GNU/Emacs]] and [[http://orgmode.org/][org-mode]]
...
I have difficulties in blogging directly in [[http://wordpress.org/][wordpress]] (it is in the click world and I'm not anymore).
