...
[[https://twitter.com/lo_dawid][A friend of mine]] showed me that he was connected to [[http://www.emacswiki.org/emacs/JabberEl][jabber]] in emacs.
...
[1] This way, if your =~/.authinfo= is compromised, only emacs is indeed.
...
To connect: =C-c C-x C-c= (=M-x jabber-disconnect=)
* Conclusion
