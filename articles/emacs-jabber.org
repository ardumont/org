...
I reuse a mechanism [[http://adumont.fr/blogging-with-org-mode-and-org2blog-to-publish-on-wordpress/#emacs][I was introduced to with org2blog]].
...
Indeed, It's the same snippet as [[http://adumont.fr/blogging-with-org-mode-and-org2blog-to-publish-on-wordpress/#install][before]], I add my new package to this list each time I need it.
