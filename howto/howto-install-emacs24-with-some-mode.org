...
[[http://www.gnu.org/software/emacs/][emacs]] 24 with [[https://github.com/technomancy/emacs-starter-kit][emacs-starter-kit]] and some interesting modes
* How to?
** Install
...
#+INCLUDE: "/home/tony/bin/setup-emacs24.sh" src emacs-lisp :lines "121-" -n
