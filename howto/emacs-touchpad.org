...
[[http://adumont.fr/stumpwm-activatedeactivate-touchpad/][In this previous post]], I explained how to switch on and off the touchpad depending on the software focused at hand[1].

[1] Recall that I'm using [[http://www.nongnu.org/stumpwm/][stumpwm]], thus meaning that I have only one window focused at a time (I can do more but [[http://adumont.fr/howto-install-stumpwm-and-little-more/][that's the way I use it]]).

It was perfect until I realized that when in [[http://www.gnu.org/software/emacs/][emacs]], I export in html and open the browser...
But then, the touchpad is off... which is now inconsistent with my [[http://adumont.fr/stumpwm-activatedeactivate-touchpad/#Setup][stumpwm setup]].
...
** Code
Then we call the script to [[http://adumont.fr/activatedeactivate-touchpad-from-the-shell/][toggle on/off the touchpad]]:
Here is the code:
...
* Conclusion
The same as the conclusion of [[http://adumont.fr/stumpwm-activatedeactivate-touchpad/][this article]], emacs rocks!
