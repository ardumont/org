...
- When switching back to the browsers (I'd like not to but there exists some web pages which does not work well without the rodent) or other mouse-needed software.
