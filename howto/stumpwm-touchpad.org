...
- [[http://adumont.fr/activatedeactivate-touchpad-from-the-shell/][I want to be able to disable/enable my touchpad]] DONE!
...
As I [[http://adumont.fr/activatedeactivate-touchpad-from-the-shell/][recently posted on how to activate/deactivate the touchpad from the shell command]], in this post, I will use those bricks to improve my condition using [[http://www.nongnu.org/stumpwm/][stumpwm]].
...
- reuse the script [[http://adumont.fr/activatedeactivate-touchpad-from-the-shell/][toggle-touchpad.sh described here]]:
