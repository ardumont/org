...
See this [[http://localhost:4000/howto-install-clojure][previous post]]
...
As we [[http://ardumont.github.io/howto-install-emacs24-with-some-mode/][already installed emacs]], we can launch the repl by doing simply:
