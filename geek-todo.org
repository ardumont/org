...
*** IN-PROGRESS Programming in haskell - ch5 - Lists comprehension - exercises
*** TODO Stumpwm - Activate/Deactivate touchpad
*** PENDING Activate/Deactivate touchpad from the shell
*** PENDING Stumpwm - Display result of bash commands using zenity
*** PENDING Daily git 2/2
*** PENDING polipo simple setup
** TODO Possible articles [0%]
