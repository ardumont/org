...
** PENDING Win a tic-tac-toe board
** PENDING Levenshtein distance
* PENDING clojure [28%]
** DONE start [100%]
...
** TODO make links to it from everywhere (gravatar, linkedin, viadeo, blog, etc...)
