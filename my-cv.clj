{:identity     {:name       "Dumont"
 ...
 :technologies {:languages       ["clojure" "*sh" "c" "java" "php" "*sql" "xhtml" "etc..."]
                :others          ["emacs-lisp" "common-lisp" "clojurescript" "objective-c" "arduino programming language"]
                :tools           {:clojure ["emacs" "leiningen"]
                                  :java    ["eclipse" "maven" "ant" ]
                                  :linux   ["emacs" "make" "*sh" ]}
                :nosql-databases ["hadoop"]
                :sql-databases   ["mysql" "postgresql" "oracle" "mssql"]
                :user-interface  {:java    ["GWT" "struts" "spring-mvc"]
                                  :clojure ["noir" "compojure"]}}
